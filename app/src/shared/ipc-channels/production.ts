...
export const productionChannels = {
  ...
  "production:addBoardFrameReference": { method: "addBoardFrameReference", kind: "invoke" },
  "production:deleteReference": { method: "deleteReference", kind: "invoke" },
  "production:renameReference": { method: "renameReference", kind: "invoke" },
  ...
  "production:importBoardImage": { method: "importBoardImage", kind: "invoke" },
  "production:importBoardVideo": { method: "importBoardVideo", kind: "invoke" },
  ...
  "production:imageUpscaleModels": { method: "imageUpscaleModels", kind: "invoke" },
  ...
  "production:generateUpscaleNode": { method: "generateUpscaleNode", kind: "invoke" },
