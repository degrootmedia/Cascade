...
function cascadeMock(): Record<string, unknown> {
  ...
  const api: Record<string, unknown> = {
    ...
    generateVoiceover: stub, importVoiceover: stub, voiceoverFile: stub,
    generateMusic: stub, importMusic: stub, musicFile: stub, removeMusic: stub, removeVoiceover: stub,
    listAudioModels: async () => [],
